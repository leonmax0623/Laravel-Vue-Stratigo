...
<head>
    ...
    <title>{{ config('app.name', 'Startego') }}</title>
...
<body class='main page'>
    <div class='main-frame' id="app">
        ...
        <div class="main-contents team-wrapper" style="width: calc(100vw - 322px);left: 305px">
                ...
                <form id="addunitForm">
                    ...
                    <div class="modal-body" style="padding-top:0;">
                        <div class="form-group">
                            ...
                            <input type="text" name="unit_name" class="form-control" style="border-radius: 2px;margin-top: 5px;" autocomplete="off" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" style="border-radius: 2px;margin-top: 5px;" autocomplete="off" />
                        </div>
                    </div>
