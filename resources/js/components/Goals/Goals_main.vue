    ...
    <div class="side-options" style="left: 90px" ref="sideapp">
      <section id="sidebar">
        <div class="secside">
          <div class="headsec">
            <h4>
              <img src="../../img/plan_goals.png" class="unity" />
              <span class="font_goals">Plan Goals</span>
            </h4>
          </div>
          ...
          >
            <li style="display: flex; align-items: center">
              <v-btn
                ...
                small
                icon
                :data-open="isOpen[unit.id]"
                style="width: 10%"
              >
                <v-icon v-if="isOpen[unit.id]">mdi-chevron-down </v-icon>
            ...
            >
              <a
                href="#"
                style="height: 39.63px"
                @click="team_id(team.id, unit.id)"
              >
                <i class="fa fa-users to" aria-hidden="true" style="left: 37px">
                  {{ team.name }}</i
                ></a
              >
            </li>
